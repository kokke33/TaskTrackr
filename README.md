...
### 🚀 v2.3.1 (2025/8/10) - テストインフラ完全修正
- **テスト安定化完了**: Unhandled Rejection エラーの完全解決
- **MSW設定最適化**: サーバーテストでの自動MSW無効化対応
- **全187テスト成功**: サーバー86 + クライアント70 + 統合31テスト
- **テスト実行環境**: エラー無しクリーン実行を実現
...
- **ユーザー名**: `admin`
- **パスワード**: `adminpassword`
- **権限**: 管理者（システム全体の管理機能にアクセス可能）

#### 一般ユーザーアカウント
- **ユーザー名**: `ss7-1`
- **パスワード**: `ss7-1weeklyreport`
- **権限**: 一般ユーザー（週次報告の作成・編集が可能）
